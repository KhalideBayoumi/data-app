...
const data: DataType = {
  ...
  valuation: [
    { rank: 1, company: "Compal Electronics Inc", value: "8.2" },
    { rank: 2, company: "Konica Minolta Inc", value: "8.7" },
    { rank: 3, company: "Seiko Epson Corp", value: "9.1" },
    { rank: 4, company: "Ricoh Co Ltd", value: "9.6" },
    { rank: 5, company: "Brother Industries Ltd", value: "10.2" },
    { rank: 6, company: "Lenovo Group Ltd", value: "10.8" },
    { rank: 7, company: "Canon Inc", value: "11.5" },
    { rank: 8, company: "HP Inc", value: "12.3" },
    { rank: 9, company: "Samsung Electronics Co Ltd", value: "13.1" },
    { rank: 10, company: "Apple Inc", value: "14.7" },
  ],
};
  ...
  return (
    <Card className="w-full h-full flex flex-col">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-lg">Industry Rank</CardTitle>
